...
// Importation du plugin Capacitor (Fonctionne Web & Mobile)
...
// FONCTION GEOLOCALISATION HYBRIDE (Web & Mobile)
const getLocation = async () => {
  loading.value = true;
  
  try {
    // Appel du plugin Capacitor : utilise le GPS sur mobile, navigator.geolocation sur Web
